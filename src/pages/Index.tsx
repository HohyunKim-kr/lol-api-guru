...
const features = [
  {
    ...
    description: "Get detailed statistics for any summoner, including win rates, most played champions, and ranked information.",
    icon: "👤"
  },
  {
    title: "Match History",
    description: "View recent matches with comprehensive data on performance, builds, and team compositions.",
    icon: "🎮"
  },
  {
    title: "Champion Analysis",
    description: "Explore champion-specific statistics, optimal builds, and performance metrics.",
    icon: "📊"
  },
];
        ...
        <section>
          ...
          >
            ...
            <motion.p 
              ...
              className="text-lg text-muted-foreground max-w-xl mx-auto"
            >
              Our platform provides comprehensive tools for League of Legends players to improve their gameplay and track their progress.
            </motion.p>
          </motion.div>
      ...
      <footer className="glass-card py-8 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-sm text-muted-foreground">
            LoL API Guru is not endorsed by Riot Games and does not reflect the views or opinions of Riot Games or anyone officially involved in producing or managing League of Legends.
          </p>
        </div>
      </footer>
    </>
